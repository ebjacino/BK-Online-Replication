...
new_color_all_stim
ggsave("graphs/new color scheme/new_color_all_stim.png", width = 10, height = 5)
```
...
ggsave("graphs/new color scheme/new orthography2.png", height = 3.5, width = 3.5)
```
...
congruency_plot_new
ggsave("graphs/new color scheme/congruency_plot_new.png", width = 3.5, height = 3.5)
```
