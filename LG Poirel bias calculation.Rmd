...
This is based off of Poire 2011, where they calculated local-global and ploted positive and negative values 
...
#in past analysis, N was number of trials (double check, Ben says that's incorrect) 
...
#make a plot where the bard are weighted??
